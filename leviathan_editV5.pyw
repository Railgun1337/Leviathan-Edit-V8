...
from PyQt6.QtGui import (
    ...
    QPaintEvent, QResizeEvent, QTextBlock, QTextDocument
)
...
# This is the superior PyQt6 implementation""")
    ...
    def set_background_image(self):
        """Set background image - ORIGINAL WORKING VERSION - DON'T TOUCH"""
        path, _ = QFileDialog.getOpenFileName(
    ...
    def clear_background_image(self):
        """Clear background image and revert to theme - DON'T TOUCH"""
        self.background_image_path = None
